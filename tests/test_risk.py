"""
test_risk.py — TDD for mt5_universal/risk/risk.py
...
_MODULES_TO_PURGE = (
    ...
    "mt5_universal.account.account",
    "mt5_universal.history",
    "mt5_universal.history.history",
)
...
class TestResolveMagic:
    ...
    def test_resolve_magic_default_when_no_strategy_id(self, mocked_mt5):
        ...
        from mt5_universal.risk.risk import resolve_magic
...
class TestCheckOrderGates:
    ...
    def test_check_order_gate_strategy_id_too_long(self, mocked_mt5):
        ...
        from mt5_universal.risk.risk import check_order, _reset_rate_limiter
        _reset_rate_limiter()
        result = check_order(
    ...
    def test_check_order_gate_rate_limit(self, mocked_mt5):
        ...
        self._setup_happy_path(mocked_mt5)
        from mt5_universal.risk.risk import check_order, _reset_rate_limiter, _rate_limiter
        _reset_rate_limiter()
        now = time.monotonic()
...
class TestComputeVolumeFromRiskPct:
    ...
    def test_compute_volume_basic(self, mocked_mt5):
        ...
        from mt5_universal.risk.risk import compute_volume_from_risk_pct
